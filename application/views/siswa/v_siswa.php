...
<a href="<?php echo base_url().'index.php/siswa/edit_siswa/'.$u->id_siswa; ?>" class="btn btn-sm btn-primary btn-icon-split">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-edit"></i>
                                        </span>
                                        <span class="text">Edit</span>
                                    </a>
<a href="<?php echo base_url().'index.php/siswa/hapus_siswa/'.$u->id_siswa; ?>" class="btn btn-sm btn-danger btn-icon-split">
                                        <span class="icon text-white-50">
